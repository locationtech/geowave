...
If you have not successfully completed the link:http://locationtech.github.io/geowave/integrate-geoserver.html#[GeoServer Integration, window="_blank"] section, please do so before continuing.
...
The GeoServer web interface can be accessed in your browser at http://localhost:8993/geoserver/web (${Master_public_DNS}:8000/geoserver/web for EMR). Login to see the layers.
