...
[NOTE]
==== 
This is a brief overview of the GeoWave architecture. For an in-depth discussion, please see the link:http://locationtech.github.io/geowave/devguide.html#architecture[GeoWave Developer Guide, window="_blank"].
====

=== Overview

image::overview1.png[scaledwidth="75%",width="75%",alt="Architecture Overview"]
