...
For a full list of GeoWave statistics commands, including examples of each, see the statistics section of the link:commands.html#statistics-commands[GeoWave CLI Documentation].
