...
All contributors must sign the link:https://www.eclipse.org/legal/eca/[Eclipse Contributor Agreement^] (see the link:https://www.eclipse.org/legal/eca/faq/[ECA FAQ^]). Use the same email address for your Eclipse account as in your Git commits.
