...
image::Clone_Download_Repo.png[scaledwidth="100%",width="100%",alt="Clone_Download_Repo.png"]

[start=4]
. Expand the “Clone or download” pane by clicking on the green button labeled "Clone or download".

image::Clone_Download_Expand.png[scaledwidth="50%",width="50%",alt="Clone_Download_Expand.png"]
