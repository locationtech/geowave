...
The above command will execute <algorithm> (such as dbscan), sourcing the data from the <store> datastore (see link:commands.html#store-add[store add in the GeoWave CLI commands, window="_blank"]).
