...
++++
      ...
      <div class="row h-100 align-items-center">
        <div class="col-lg-6">
          ...
          <div class="downloads mb-5">
            <span class="text-white mb-3">Get GeoWave</span> <span class="text-primary pipe mx-2 pl-2"> | </span>
            <a href="installation-guide.html" class="p-2 mr-1 text-white">Installation Guide</a>
            <a href="downloads.html" class="p-2 m-1 text-white">Downloads</a>
          </div>
  ...
  <section class="geo-home-why container mb-5 pb-5">
    ...
    <div class="row my-4">
      ...
      <div class="col-md-4 mb-5">
        <a href="userguide.html#queries" class="card h-100 border-0 text-center">
          <div class="card-body pb-1">
