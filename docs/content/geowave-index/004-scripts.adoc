...
<script>
	...
	$( document ).ready(function() {
		var prevReleases = [ "0.9.5", "0.9.4.1", "0.9.4", "0.9.3" ];
		var menu = $('#releases_submenu')
		jQuery.each( prevReleases, function( index, value ) {
			...
			var docs = { "userguide.html": "User Guide", "devguide.html": "Developer Guide", "commands.html": "CLI Commands", "quickstart.html": "Quickstart Guide" };
			$.each( docs, function( filename, label ) {
