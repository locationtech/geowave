...
public class JobContextAdapterIndexMappingStore implements AdapterIndexMappingStore {
  ...
  public JobContextAdapterIndexMappingStore(
      final JobContext context, final AdapterIndexMappingStore persistentAdapterIndexMappingStore) {
  ...
  public static void addAdapterToIndexMapping(
      final Configuration configuration, final AdapterToIndexMapping adapter) {
  ...
  public boolean remove(final short internalAdapterId, String indexName) {
    ...
    if (indexNames.length > 1) {
      ...
      adapterCache.remove(internalAdapterId);
      adapterCache.put(
          mapping.getAdapterId(), new AdapterToIndexMapping(internalAdapterId, newIndices));
    } else {
