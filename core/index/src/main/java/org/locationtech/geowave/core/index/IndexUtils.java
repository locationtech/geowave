...
public class IndexUtils {
  ...
  public static final double getDimensionalBitsUsed(
      final NumericIndexStrategy indexStrategy, final double[] dataRangePerDimension) {
  ...
  public static double[] inflateRange(
      final double[] cellRangePerDimension, final double[] dataRangePerDimension) {
  ...
  public static double[][] getBitsFromTheRightPerDimension(
      final BinRange[][] binsPerDimension, final double[] cellRangePerDimension) {
  ...
  public static int getBitPositionOnSortKeyFromSubsamplingArray(
    ...
    return (int)
        Math.round(getDimensionalBitsUsed(indexStrategy, maxResolutionSubsamplingPerDimension));
  }
  ...
  private static final double[] getBitsPerDimension(
      final NumericIndexStrategy indexStrategy, final double[] rangePerDimension) {
  ...
  public static Set<ByteArray> getInsertionPartitionKeys(
      final NumericIndexStrategy strategy, final MultiDimensionalNumericData insertionData) {
