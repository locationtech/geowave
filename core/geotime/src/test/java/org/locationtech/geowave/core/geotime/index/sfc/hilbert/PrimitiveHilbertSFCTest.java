...
public class PrimitiveHilbertSFCTest {
  ...
  public void testSpatialGetIdAndQueryDecomposition62BitsTotal() {
    ...
    final double[] testValues4 =
        new double[] {-61.2354561024897435868943753568436598645436,
    ...
    final NumericRange rangeLatitude2 =
        new NumericRange(-43.7894445665435346547657867847657654,
    ...
    final RangeDecomposition expectedResult1 =
        expectedResultOperations.decomposeRange(
            new NumericData[] {rangeLongitude1, rangeLatitude1}, compactHilbertCurve, sfcDimensions,
            totalPrecision, Integer.MAX_VALUE, true, true);
    ...
    final RangeDecomposition expectedResult2 =
        expectedResultOperations.decomposeRange(
            new NumericData[] {rangeLongitude2, rangeLatitude2}, compactHilbertCurve, sfcDimensions,
            totalPrecision, Integer.MAX_VALUE, true, true);
    ...
    final RangeDecomposition expectedResult3 =
        expectedResultOperations.decomposeRange(
            new NumericData[] {rangeLongitude3, rangeLatitude3}, compactHilbertCurve, sfcDimensions,
            totalPrecision, Integer.MAX_VALUE, true, false);
    ...
    final RangeDecomposition expectedResult4 =
        expectedResultOperations.decomposeRange(
            new NumericData[] {rangeLongitude4, rangeLatitude4}, compactHilbertCurve, sfcDimensions,
            totalPrecision, Integer.MAX_VALUE, true, false);
  ...
  public void testGetId48BitsPerDimension() {
    ...
    final double[] testValues4 =
        new double[] {0.2354561024897435868943753568436598645436,
