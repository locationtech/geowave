...
public class TWKBTest
{
	...
	public static void init() {
		...
		writer3Precision = new TWKBWriter(
				3);
		writer0Precision = new TWKBWriter(
				0);
		writerNegativePrecision = new TWKBWriter(
				-3);
	...
	public void testReadWritePoint()
		...
		Point point = factory.createPoint(new Coordinate(
				12.13281248321,
				-1518.375));
		Point expected = factory.createPoint(new Coordinate(
				12.1328125,
				-1518.375)); // maximum precision is 7 decimal digits
		...
		expected = factory.createPoint(new Coordinate(
				12.133,
				-1518.375));
	...
	public void testReadWriteLine()
		...
		LineString expected = factory.createLineString(new Coordinate[] {
			new Coordinate(
					12.1328125,
					-1518.375),
			new Coordinate(
		...
		expected = factory.createLineString(new Coordinate[] {
			new Coordinate(
					12.133,
					-1518.375),
			new Coordinate(
	...
	public void testReadWriteMultiPoint()
			throws ParseException {
		MultiPoint points = factory.createMultiPoint(new Point[] {
		...
		MultiPoint expected = factory.createMultiPoint(new Point[] {
			factory.createPoint(new Coordinate(
					12.1328125,
					-1518.375)),
			factory.createPoint(new Coordinate(
		...
		expected = factory.createMultiPoint(new Point[] {
			factory.createPoint(new Coordinate(
					12.133,
					-1518.375)),
			factory.createPoint(new Coordinate(
	...
	@Test
	public void testReadWriteMultiLineString()
			throws ParseException {
	...
	@Test
	public void testReadWriteMultiPolygon()
			throws ParseException {
	...
	@Test
	public void testReadWriteGeometryCollection()
			throws ParseException {
