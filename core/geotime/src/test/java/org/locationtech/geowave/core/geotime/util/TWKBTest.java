...
public class TWKBTest {
  ...
  public void testReadWriteLine() throws ParseException {
    LineString line =
        factory.createLineString(
            new Coordinate[] {new Coordinate(12.13281248321, -1518.375),
                new Coordinate(15.875, -1495.38281248325), new Coordinate(17.2635, -1384.75)});
    LineString expected =
        factory.createLineString(
            new Coordinate[] {new Coordinate(12.1328125, -1518.375),
    ...
    expected =
        factory.createLineString(
            new Coordinate[] {new Coordinate(12.133, -1518.375), new Coordinate(15.875, -1495.383),
    ...
    expected =
        factory.createLineString(
            new Coordinate[] {new Coordinate(12, -1518), new Coordinate(16, -1495),
  ...
  public void testReadWritePolygon() throws ParseException {
    ...
    expected =
        factory.createPolygon(
            factory.createLinearRing(
                new Coordinate[] {new Coordinate(12.133, -1518.375),
            ...
            new LinearRing[] {
                factory.createLinearRing(
                    new Coordinate[] {new Coordinate(14, -1500), new Coordinate(20, -1495),
                        new Coordinate(20, -1350), new Coordinate(14, -1349),
    ...
    expected =
        factory.createPolygon(
            factory.createLinearRing(
                new Coordinate[] {new Coordinate(0, -2000), new Coordinate(0, -2000),
  ...
  public void testReadWriteMultiPoint() throws ParseException {
    ...
    MultiPoint expected =
        factory.createMultiPoint(
            new Point[] {factory.createPoint(new Coordinate(12.1328125, -1518.375)),
    ...
    expected =
        factory.createMultiPoint(
            new Point[] {factory.createPoint(new Coordinate(12.133, -1518.375)),
    ...
    expected =
        factory.createMultiPoint(
            new Point[] {factory.createPoint(new Coordinate(12, -1518)),
    ...
    expected =
        factory.createMultiPoint(
            new Point[] {factory.createPoint(new Coordinate(0, -2000)),
    ...
    MultiPolygon multiPoly =
        factory.createMultiPolygon(
            new Polygon[] {
                factory.createPolygon(
                    factory.createLinearRing(
                        new Coordinate[] {new Coordinate(12.13281248321, -1518.375),
                            ...
                            new Coordinate(24.2635, -1284.75), new Coordinate(12.325, -1282.125),
                ...
                factory.createPolygon(
                    factory.createLinearRing(
                        new Coordinate[] {new Coordinate(1513.5, -0.1),
                    ...
                    factory.createPolygon(
                        factory.createLinearRing(
                            new Coordinate[] {new Coordinate(12, -1518), new Coordinate(25, -1518),
                                new Coordinate(
                                    24, -1285),
                                new Coordinate(12, -1282), new Coordinate(12, -1518)}),
                        new LinearRing[] {
                            factory.createLinearRing(
                                new Coordinate[] {new Coordinate(14, -1500),
                                    new Coordinate(20, -1495), new Coordinate(20, -1350),
                                    new Coordinate(14, -1349), new Coordinate(14, -1500)}),
                            factory.createLinearRing(
                                new Coordinate[] {new Coordinate(14, -1325),
                                    new Coordinate(20, -1350), new Coordinate(20, -1450),
                                    new Coordinate(14, -1325)})}),
                    factory.createPolygon(
                        factory.createLinearRing(
                            new Coordinate[] {new Coordinate(1514, 0), new Coordinate(1520, -95),
                                new Coordinate(1520, -50), new Coordinate(1514, -49),
    ...
    expected =
        factory.createMultiPolygon(
            new Polygon[] {
                ...
                factory.createPolygon(
                    factory.createLinearRing(
                        new Coordinate[] {new Coordinate(2000, 0), new Coordinate(2000, 0),
                            new Coordinate(2000, 0), new Coordinate(2000, 0),
