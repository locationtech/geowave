...
public class TWKBTest {
  ...
  public void testReadWriteLine() throws ParseException {
    ...
    expected =
        factory.createLineString(
            new Coordinate[] {
              new Coordinate(12, -1518), new Coordinate(16, -1495), new Coordinate(17, -1385)
            });
    ...
    expected =
        factory.createLineString(
            new Coordinate[] {
              new Coordinate(0, -2000), new Coordinate(0, -1000), new Coordinate(0, -1000)
            });
    ...
    MultiLineString line =
        factory.createMultiLineString(
            new LineString[] {
              factory.createLineString(
                  new Coordinate[] {
                    new Coordinate(13.5, -1500.1), new Coordinate(20.273, -1495.342)
                  }),
              factory.createLineString(
                  new Coordinate[] {
                    new Coordinate(12.13281248321, -1518.375),
    ...
    expected =
        factory.createMultiLineString(
            new LineString[] {
              ...
              factory.createLineString(
                  new Coordinate[] {
                    new Coordinate(14, -1325), new Coordinate(20, -1350), new Coordinate(20, -1450)
                  })
            });
    encoded = writer0Precision.write(line);
    decoded = reader.read(encoded);
