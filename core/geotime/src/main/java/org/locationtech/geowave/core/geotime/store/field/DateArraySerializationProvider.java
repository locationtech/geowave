		...
		FieldSerializationProviderSpi<Date[]>
{
	...
	private static class DateArrayReader implements
			FieldReader<Date[]>
	{
		@Override
		...
		public Date[] readField(
			...
			if (serializationVersion < FieldUtils.SERIALIZATION_VERSION) {
				return new ArrayReader<Date>(
						new DateReader()).readField(
						fieldData,
	...
	private static class DateArrayWriter implements
