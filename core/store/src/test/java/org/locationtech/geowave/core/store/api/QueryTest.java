...
public class QueryTest {
    ...
    public void querySingle(){
        Writer<Integer> writer = dataStore.createWriter(adapter.getTypeName());
    ...
    public void queryTwoTypes(){
        ...
        try (CloseableIterator<?> itemIt2 =
            ...
            //System.out.println(itemIt2.next().toString());
