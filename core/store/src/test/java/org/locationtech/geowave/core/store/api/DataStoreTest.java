...
public class DataStoreTest {
    ...
    /*
    Untestable code:
    baseOperations.deleteAll(indexName, typeName, adapterId); just returns false and does not actually delete anything.
    src: MemoryDataStoreOperations#deleteAll(table, type, adapter, args)
     */
    @Ignore @Test
    ...
    Untestable code:
    baseOperations.deleteAll(indexName, typeName, adapterId); just returns false and does not actually delete anything.
    src: BaseDataStore#removeIndex(type, index) -> MemoryDataStoreOperations#deleteAll(table, type, adapter, args)
