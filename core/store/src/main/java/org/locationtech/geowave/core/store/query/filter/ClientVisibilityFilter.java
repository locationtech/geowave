...
/**
 * Provides a visibility filter for UNMERGED rows. The filter only operates on the first {@link
 * GeoWaveValue} of each row and must be applied prior to row merging.
 */
