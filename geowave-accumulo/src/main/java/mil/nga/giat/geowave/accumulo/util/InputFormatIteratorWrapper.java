...
import mil.nga.giat.geowave.accumulo.mapreduce.HadoopAdapterStore;
		...
		Iterator<Entry<GeoWaveInputKey, T>>
{
	...
	private Entry<GeoWaveInputKey, T> decodeRow(
		...
		final ByteArrayId adapterId = new ByteArrayId(
				rowId.getAdapterId());
		T result = (T) (isOutputWritable ? adapterStore.getHadoopWritableSerializerForAdapter(
