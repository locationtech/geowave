...
public class EntryFilterIterator extends
		Filter
{
	private final static Logger LOGGER = Logger.getLogger(AccumuloDataStore.class);
	protected static final String ENTRY_FILTER_ITERATOR_NAME = "GEOWAVE_ENTRY_FILTER_ITERATOR";
	protected static final int ENTRY_FILTER_ITERATOR_PRIORITY = 15;
	protected static final String WHOLE_ROW_ITERATOR_NAME = "GEOWAVE_WHOLE_ROW_ITERATOR";
	protected static final int WHOLE_ROW_ITERATOR_PRIORITY = ENTRY_FILTER_ITERATOR_PRIORITY - 1;
	...
	public void init(
		...
		if (adapterIdStr == null) {
			throw new IllegalArgumentException(
					"'adapterid' must be set for " + EntryFilterIterator.class.getName());
		}
		if (dataIdStr == null) {
			throw new IllegalArgumentException(
					"'dataid' must be set for " + EntryFilterIterator.class.getName());
		}
