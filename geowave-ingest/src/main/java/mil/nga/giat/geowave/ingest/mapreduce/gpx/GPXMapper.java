...
public class GPXMapper extends Mapper<AvroKey<GPXTrack>, NullWritable, ByteArrayId, Object> {
	...
	@Override
	protected void map( AvroKey<GPXTrack> key, NullWritable value, Context context )
			throws IOException,
			InterruptedException {
	...
	protected void processTrack( GPXTrack gpxTrack, Mapper<AvroKey<GPXTrack>, NullWritable, ByteArrayId, Object>.Context context )
		...
		long trackPoint = 0;
		List<Coordinate> coordinateSequence = new ArrayList<Coordinate>();
		String name = null;
		String cmt = null;
		String desc = null;
		String sym = null;
		...
		if (gpxTrack.getTags() != null && gpxTrack.getTags().size() > 0) {
			String tags = org.apache.commons.lang.StringUtils.join(gpxTrack.getTags(), TAG_SEPARATOR);
