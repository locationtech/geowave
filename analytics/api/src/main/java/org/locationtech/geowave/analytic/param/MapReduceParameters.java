...
public class MapReduceParameters {
  ...
  public enum MRConfig implements ParameterEnum {
    ...
    HDFS_HOST_PORT(
        String.class, "hdfs", "HDFS hostname and port in the format hostname:port", true),
    HDFS_BASE_DIR(
        String.class, "hdfsbase", "Fully qualified path to the base directory in hdfs", true),
