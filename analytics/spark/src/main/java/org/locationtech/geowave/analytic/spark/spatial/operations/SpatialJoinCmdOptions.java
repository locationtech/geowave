...
public class SpatialJoinCmdOptions {
  ...
  @Parameter(
      ...
      description =
          "The default partition count to set for Spark RDDs. Should be big enough to support largest RDD that will be used. Sets spark.default.parallelism")
  ...
  @Parameter(
      ...
      description =
          "Used for distance join predicate and other spatial operations that require a scalar radius.")
