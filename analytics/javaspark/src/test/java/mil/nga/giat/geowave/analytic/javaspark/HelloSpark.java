...
public class HelloSpark
{
	...
	/**
	 * OUTPUT: [(index.html,1.2.3.4), (about.html,3.4.5.6), (index.html,1.3.3.1)]
	 *         [(index.html,Home), (about.html,About)]
	 *         [(index.html,(1.2.3.4,Home)), (index.html,(1.3.3.1,Home)), (about.html,(3.4.5.6,About))]
	 * 
	 * @param context
	 */
	private static void join(
		...
		JavaPairRDD<String, String> visitsRDD = JavaPairRDD.fromJavaRDD(
				context.parallelize(
						Arrays.asList(
		...
		System.out.println(
				visitsRDD.collect().toString());

		JavaPairRDD<String, String> pageNamesRDD = JavaPairRDD.fromJavaRDD(
				context.parallelize(
						Arrays.asList(
								new Tuple2<String, String>(
										"index.html",
		...
		System.out.println(
				pageNamesRDD.collect().toString());

		JavaPairRDD<String, Tuple2<String, String>> joinRDD = visitsRDD.join(
				pageNamesRDD);
		System.out.println(
				joinRDD.collect().toString());

	}

	/**
	 * OUTPUT: [(index.html,1.2.3.4), (about.html,3.4.5.6), (index.html,1.3.3.1)]
	 *         [(index.html,Home), (index.html,Welcome), (about.html,About)]
	 * 
	 * @param context
	 */
	private static void coGroup(
		...
		JavaPairRDD<String, Tuple2<Iterable<String>, Iterable<String>>> joinRDD = visitsRDD.cogroup(
				pageNamesRDD);
		System.out.println(
				joinRDD.collect().toString());
	}
	...
	private static void unionAndDistinct(
		...
		JavaRDD<Integer> numbers1RDD = context.parallelize(
				Arrays.asList(
						0,
						5,
						3));
		JavaRDD<Integer> numbers2RDD = context.parallelize(
				Arrays.asList(
						8,
						9,
						3));

		JavaRDD<Integer> unionRDD = numbers1RDD.union(
				numbers2RDD);
		System.out.println(
				unionRDD.collect().toString());

		JavaRDD<Integer> distinctRDD = unionRDD.distinct();
		System.out.println(
				distinctRDD.collect().toString());
	}
	...
	private static void take(
		...
		List<Integer> numbersList = numbersRDD.take(
				3);
		System.out.println(
				numbersList.toString());
