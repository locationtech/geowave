...
public abstract class GeoWaveAnalyticJobRunner extends Configured
  ...
  public PersistentAdapterStore getAdapterStore(final PropertyManagement runTimeProperties)
    ...
    final PersistableStore store =
        (PersistableStore)
            StoreParameters.StoreParam.INPUT_STORE.getHelper().getValue(runTimeProperties);
  ...
  public int run(final Configuration configuration, final PropertyManagement runTimeProperties)
    ...
    runTimeProperties.setConfig(
        new ParameterEnum[] {StoreParam.INPUT_STORE}, configuration, getScope());
  ...
  public Collection<ParameterEnum<?>> getParameters() {
    ...
    params.addAll(
        Arrays.asList(
            new ParameterEnum<?>[] {
              StoreParam.INPUT_STORE, Output.REDUCER_COUNT, Output.OUTPUT_FORMAT
            }));
    return params;
  }
  ...
  protected InternalDataAdapter<?> getAdapter(
    ...
    if (convexHullInternalAdapterId == null) {
      final String namespaceURI =
          runTimeProperties
              .storeIfEmpty(dataNameSpaceEnum, BasicFeatureTypes.DEFAULT_NAMESPACE)
              .toString();
