...
public class KmeansJumpCommand extends DefaultOperation implements Command {
  ...
  @ParametersDelegate private CommonOptions commonOptions = new CommonOptions();

  @ParametersDelegate private KMeansCommonOptions kmeansCommonOptions = new KMeansCommonOptions();

  @ParametersDelegate private KMeansJumpOptions kmeansJumpOptions = new KMeansJumpOptions();
