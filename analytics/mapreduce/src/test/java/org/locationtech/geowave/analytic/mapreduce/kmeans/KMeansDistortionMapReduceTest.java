...
public class KMeansDistortionMapReduceTest {
  ...
  public void setUp() throws IOException {
    ...
    JobContextInternalAdapterStore.addTypeName(
        mapDriver.getConfiguration(), testObjectAdapter.getTypeName(), adapterId);
    JobContextInternalAdapterStore.addTypeName(
        reduceDriver.getConfiguration(), testObjectAdapter.getTypeName(), adapterId);
    ...
    propManagement.store(
        CentroidParameters.Centroid.DATA_NAMESPACE_URI, ftype.getName().getNamespaceURI());
