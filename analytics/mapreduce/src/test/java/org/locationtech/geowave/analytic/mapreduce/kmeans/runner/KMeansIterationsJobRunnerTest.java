...
public class KMeansIterationsJobRunnerTest {
  ...
  public void testRun() throws Exception {
    ...
    for (final Map.Entry<String, List<AnalyticItemWrapper<SimpleFeature>>> e :
        KMeansIterationsJobRunnerForTest.groups.entrySet()) {
      ...
      for (final AnalyticItemWrapper<SimpleFeature> newCentroid : e.getValue()) {
        ...
        boolean b = false;
        for (final AnalyticItemWrapper<SimpleFeature> oldCentroid :
            KMeansIterationsJobRunnerForTest.deletedSet.get(e.getKey())) {
    ...
    for (final Map.Entry<String, List<AnalyticItemWrapper<SimpleFeature>>> e :
        KMeansIterationsJobRunnerForTest.deletedSet.entrySet()) {
      assertEquals(3, e.getValue().size());
    ...
    protected CentroidManager<SimpleFeature> constructCentroidManager(
      ...
      return new CentroidManager<SimpleFeature>() {
        ...
        public void delete(final String[] dataIds) throws IOException {
          ...
          for (final Map.Entry<String, List<AnalyticItemWrapper<SimpleFeature>>> entry :
              groups.entrySet()) {
        ...
        public AnalyticItemWrapper<SimpleFeature> getCentroidById(
            final String id, final String groupID)
