...
public class OSMIngestCommandArgs {
  ...
  @ParametersDelegate private final VisibilityOptions visibilityOptions = new VisibilityOptions();
  ...
  @Parameter(
      names = {"--table"},
      required = false,
      description = "OSM Table name in GeoWave")
  ...
  public String serializeToString() {
    ...
    sb.append(osmNamespace)
        .append(separator)
        .append(visibilityOptions.getVisibility())
        .append(separator)
        .append(hdfsBasePath)
        .append(separator)
        .append(jobName)
