		...
		Landsat8AnalyzeCommand
{
	...
	protected void nextBand(
		...
		super.nextBand(
				band,
				analysisInfo);
		final String downloadUrl = (String) band.getAttribute(
	...
	protected static File getDownloadFile(
		...
		final int path = (int) band.getAttribute(
				SceneFeatureIterator.PATH_ATTRIBUTE_NAME);
		final int row = (int) band.getAttribute(
				SceneFeatureIterator.ROW_ATTRIBUTE_NAME);
		final String entity = (String) band.getAttribute(
