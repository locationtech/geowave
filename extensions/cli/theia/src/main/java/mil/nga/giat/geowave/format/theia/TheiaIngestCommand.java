...
@GeowaveOperation(name = "ingest", parentOperation = TheiaSection.class)
@Parameters(commandDescription = "Ingest routine for locally downloading Theia imagery and ingesting it into GeoWave's raster store and in parallel ingesting the scene metadata into GeoWave's vector store.  These two stores can actually be the same or they can be different.")
public class TheiaIngestCommand extends
