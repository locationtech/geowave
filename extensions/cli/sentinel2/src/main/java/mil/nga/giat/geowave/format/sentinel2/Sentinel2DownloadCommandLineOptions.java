...
{
	@Parameter(names = "--userident", description = "email address to authentificate when downloading Theia imagery.", required = false)
	private String userIdent;
	@Parameter(names = "--password", description = "Password to authentificate when downloading Theia imagery.", required = false)
