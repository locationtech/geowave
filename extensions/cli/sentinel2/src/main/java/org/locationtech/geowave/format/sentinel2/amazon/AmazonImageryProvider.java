...
public class AmazonImageryProvider extends Sentinel2ImageryProvider {
  ...
  public Iterator<SimpleFeature> searchScenes(
    ...
    if ((location != null) && (location.length() > 0)) {
      ...
      if (extraFilter.equals(Filter.INCLUDE)) extraFilter = temp;
      else extraFilter = FF.and(extraFilter, temp);
    }
  ...
  private static boolean downloadFile(
      final String downloadUrl, final File sceneDir, final String resourceName) throws IOException {
