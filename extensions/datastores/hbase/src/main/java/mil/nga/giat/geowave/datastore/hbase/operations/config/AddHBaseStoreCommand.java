...
@GeowaveOperation(name = "hbase", parentOperation = AddStoreSection.class, restEnabled = GeowaveOperation.RestEnabledType.POST)
@Parameters(commandDescription = "Create a HBase store within Geowave")
		...
		Command
{
	...
	@ParametersDelegate
	private HBaseRequiredOptions hbaseReqOptions = new HBaseRequiredOptions();
	...
	public boolean prepare(
		...
		pluginOptions.setFactoryOptions(hbaseReqOptions);
		pluginOptions.setFactoryFamily(new HBaseStoreFactoryFamily());
