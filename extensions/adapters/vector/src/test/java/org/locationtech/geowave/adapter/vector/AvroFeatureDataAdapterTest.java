...
public class AvroFeatureDataAdapterTest {
  ...
  private static void ingestCannedData(
      final FeatureDataAdapter adapter, final List<SimpleFeature> data) throws IOException {
  ...
  public void basicTest() throws Exception {
    ...
    final AvroFeatureDataAdapter adapter = new AvroFeatureDataAdapter(schema);
    ...
    bldr =
        bldr.constraints(
            bldr.constraintsFactory()
                ...
                .spatialConstraints(new GeometryFactory().createPolygon(coordArray))
                .build());
  ...
  public void testDifferentProjection() throws SchemaException {
    ...
    final AvroFeatureDataAdapter dataAdapter =
        new AvroFeatureDataAdapter(
    ...
    final AdapterPersistenceEncoding persistenceEncoding =
        dataAdapter.encode(
            originalFeature, new SpatialIndexBuilder().createIndex().getIndexModel());
