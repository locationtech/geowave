...
import org.locationtech.geowave.adapter.vector.query.gwql.AdapterEntryResultSet;
...
import org.locationtech.geowave.adapter.vector.query.gwql.GWQLExtensionRegistry;
...
public class SelectStatement<T> implements Statement {
  ...
  public ResultSet execute(final String... authorizations) {
    ...
    if (isAggregation()) {
      ...
      final CompositeVectorAggregation<T> composite = new CompositeVectorAggregation<>();
