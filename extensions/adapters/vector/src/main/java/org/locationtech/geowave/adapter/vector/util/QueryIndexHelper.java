...
public class QueryIndexHelper {
              ...
              ? ((FeatureTimeRangeStatistics)
                  stats.get(
                      VectorStatisticsQueryBuilder.newBuilder()
                          .factory()
                          .timeRange()
                          .fieldName(timeDescriptors.getEndRange().getLocalName())
                          .build()
                          .getId()))
              : null;
              ...
              ? ((FeatureTimeRangeStatistics)
                  stats.get(
                      VectorStatisticsQueryBuilder.newBuilder()
                          .factory()
                          .timeRange()
                          .fieldName(timeDescriptors.getStartRange().getLocalName())
                          .build()
                          .getId()))
              : null;
          ...
          ((FeatureTimeRangeStatistics)
              stats.get(
                  VectorStatisticsQueryBuilder.newBuilder()
                      .factory()
                      .timeRange()
                      .fieldName(timeDescriptors.getTime().getLocalName())
                      .build()
                      .getId()));
      if (timeStat != null) {
  ...
  public static Constraints composeTimeBoundedConstraints(
    ...
    return (boundsTimeConstraints.matches(indexTimeConstraints))
        ? new Constraints()
  ...
  public static GeoConstraintsWrapper composeGeometricConstraints(
    ...
    if (geoConstraints.getConstraints().matches(statsConstraints)) {
      return new GeoConstraintsWrapper(
          new Constraints(), geoConstraints.isConstraintsMatchGeometry(), jtsBounds);
    }
