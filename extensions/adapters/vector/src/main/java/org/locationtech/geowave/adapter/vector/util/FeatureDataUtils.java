...
public class FeatureDataUtils {
  ...
  public static SimpleFeatureType decodeType(
      final String nameSpace, final String typeName, final String typeDescriptor, final String axis)
      ...
      try {
        ...
        featureType =
            SimpleFeatureTypeBuilder.retype(
                featureType, CRS.decode("EPSG:4326", lCaseAxis.equals("east")));
  ...
  public static SimpleFeature buildFeature(
      final SimpleFeatureType featureType, final Pair<String, Object>[] entries) {
  ...
  public static SimpleFeatureType getFeatureType(
      final DataStorePluginOptions dataStore, String typeName) {
