...
public class WebMercatorRasterTest {
  ...
  public void testStoreRetrieve()
      throws MismatchedIndexToAdapterMapping, IOException, MismatchedDimensionException,
    ...
    final double[] maxesPerBand =
        new double[] {
          (xTiles * 3) + (yTiles * 24), (xTiles * 3) + (yTiles * 24), (xTiles * 3) + (yTiles * 24)
        };
      ...
      for (int yTile = 1; yTile < yTiles; yTile++) {
        ...
        final GridCoverage gridCoverage =
            reader.renderGridCoverage(
                "test", new Rectangle(32, 32), queryEnvelope, null, null, null);
