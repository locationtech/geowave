...
public class Stanag4676EventWritable implements Writable {
  ...
  public void setTrackObjectClassData(
      final long timeStamp, final String objectClass, final int objectConf, final int objectRel) {
  ...
  public void setMissionFrameData(
      final byte[] geometry, final String missionUUID, final int number, final long timeStamp) {
