 ...
 ******************************************************************************/
package mil.nga.giat.geowave.format.osm.feature.types;
...
import mil.nga.giat.geowave.format.osm.feature.types.attributes.AttributeDefinition;
import mil.nga.giat.geowave.format.osm.feature.types.attributes.AttributeType;
import mil.nga.giat.geowave.format.osm.feature.types.attributes.AttributeTypes;
...
public class FeatureDefinitionSet
{
	...
	public final static Map<String, FeatureDataAdapter> featureAdapters = new HashMap(new HashMap<String, FeatureDataAdapter>());
	public final static Map<String, SimpleFeatureType> featureTypes = new HashMap(new HashMap<String, SimpleFeatureType>());
