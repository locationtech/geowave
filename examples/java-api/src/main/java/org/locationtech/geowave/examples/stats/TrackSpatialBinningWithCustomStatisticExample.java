...
public class TrackSpatialBinningWithCustomStatisticExample {
  ...
  private void displayTrackStatistics(
    ...
    // Display track count by spatial bin, this shows as 0 because it is weighted count and each
    // track is contributing to so many spatial bins that the weighted count rounds to 0
    if (trackCount != null) {
