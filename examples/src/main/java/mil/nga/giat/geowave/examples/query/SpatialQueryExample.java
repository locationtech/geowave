...
public class SpatialQueryExample {
    ...
    public static void main(String[] args) throws AccumuloSecurityException, AccumuloException, ParseException, CQLException, IOException {
...
//        \x1F\x11\xCB\xFC\xB6\xEFT\x00\xFFcomplex_feature\x00\x00\x00\x0E\x00\x00\x00\x01\x00\x00\x00\x00 complex_feature:longitude []    \xC0]\x91\x18\xC0\x00\x00\x
     ...
     */
    private void pointQueryCase1() throws ParseException, IOException {
        ...
        try (CloseableIterator<SimpleFeature> queryResultIterator = dataStore.query(
                bfAdapter,
     ...
     */
    private void pointQueryCase2() throws ParseException, IOException {
     ...
     */
    private void pointQueryCase4() throws ParseException, CQLException, IOException {
     ...
     */
    private void polygonQueryCase1() throws ParseException, IOException {
        log.info("Running Point Query Case 4");
        //First, we need to obtain the adapter for the SimpleFeature we want to query.
