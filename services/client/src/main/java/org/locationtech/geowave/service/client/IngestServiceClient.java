...
public class IngestServiceClient {
  ...
  public Response localToGW(
      final String file_or_directory, final String storename, final String index_group_list) {
  ...
  public Response localToHdfs(
      final String file_or_directory, final String path_to_base_directory_to_write_to) {
  ...
  public Response sparkToGW(
      final String input_directory, final String store_name, final String index_group_list) {
    return sparkToGW(
        input_directory,
        store_name,
        index_group_list,
