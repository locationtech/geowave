...
public class GeoAxisTokenServices extends
		RemoteTokenServices
{
	...
	private AccessTokenConverter tokenConverter = new GeoAxisAccessTokenConverter();

	public GeoAxisTokenServices() {
	...
	public OAuth2Authentication loadAuthentication(
		...
		// gh-838
		/*
		 * if (!Boolean.TRUE.equals(map.get("active"))) { logger.debug(
		 * "check_token returned active attribute: " + map.get("active")); throw
		 * new InvalidTokenException( accessToken); }
		 */
