...
/**
 * Copied the DefaultAccessTokenConverter and modified for GEOAxIS token
 * details.
 */
public class GeoAxisAccessTokenConverter extends
		DefaultAccessTokenConverter
{
	...
	public GeoAxisAccessTokenConverter() {
