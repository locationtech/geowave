...
public class GpxTrack extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
   ...
   */
  public GpxTrack(java.lang.Long trackid, java.lang.Long timestamp, java.nio.ByteBuffer gpxfile, java.lang.Long points, java.lang.CharSequence visibility, java.lang.CharSequence user, java.lang.Long userid, java.lang.CharSequence description, java.util.List<java.lang.CharSequence> tags) {
  ...
  public static mil.nga.giat.geowave.types.gpx.GpxTrack.Builder newBuilder() {
    return new mil.nga.giat.geowave.types.gpx.GpxTrack.Builder();
  }
  
  /** Creates a new GPXTrack RecordBuilder by copying an existing Builder */
  public static mil.nga.giat.geowave.types.gpx.GpxTrack.Builder newBuilder(mil.nga.giat.geowave.types.gpx.GpxTrack.Builder other) {
    return new mil.nga.giat.geowave.types.gpx.GpxTrack.Builder(other);
  }
  
  /** Creates a new GPXTrack RecordBuilder by copying an existing GPXTrack instance */
  public static mil.nga.giat.geowave.types.gpx.GpxTrack.Builder newBuilder(mil.nga.giat.geowave.types.gpx.GpxTrack other) {
    return new mil.nga.giat.geowave.types.gpx.GpxTrack.Builder(other);
  }
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<GpxTrack>
    ...
    private Builder() {
      super(mil.nga.giat.geowave.types.gpx.GpxTrack.SCHEMA$);
    }
    
    /** Creates a Builder by copying an existing Builder */
    private Builder(mil.nga.giat.geowave.types.gpx.GpxTrack.Builder other) {
      super(other);
    ...
    private Builder(mil.nga.giat.geowave.types.gpx.GpxTrack other) {
            super(mil.nga.giat.geowave.types.gpx.GpxTrack.SCHEMA$);
      if (isValidValue(fields()[0], other.trackid)) {
        this.trackid = data().deepCopy(fields()[0].schema(), other.trackid);
        fieldSetFlags()[0] = true;
    ...
    /** Sets the value of the 'trackid' field */
    public mil.nga.giat.geowave.types.gpx.GpxTrack.Builder setTrackid(java.lang.Long value) {
    ...
    public mil.nga.giat.geowave.types.gpx.GpxTrack.Builder clearTrackid() {
      trackid = null;
    ...
    /** Sets the value of the 'timestamp' field */
    public mil.nga.giat.geowave.types.gpx.GpxTrack.Builder setTimestamp(java.lang.Long value) {
    ...
    public mil.nga.giat.geowave.types.gpx.GpxTrack.Builder clearTimestamp() {
      timestamp = null;
    ...
    /** Sets the value of the 'gpxfile' field */
    public mil.nga.giat.geowave.types.gpx.GpxTrack.Builder setGpxfile(java.nio.ByteBuffer value) {
    ...
    public mil.nga.giat.geowave.types.gpx.GpxTrack.Builder clearGpxfile() {
      gpxfile = null;
    ...
    /** Sets the value of the 'points' field */
    public mil.nga.giat.geowave.types.gpx.GpxTrack.Builder setPoints(java.lang.Long value) {
    ...
    public mil.nga.giat.geowave.types.gpx.GpxTrack.Builder clearPoints() {
      points = null;
    ...
    /** Sets the value of the 'visibility' field */
    public mil.nga.giat.geowave.types.gpx.GpxTrack.Builder setVisibility(java.lang.CharSequence value) {
    ...
    public mil.nga.giat.geowave.types.gpx.GpxTrack.Builder clearVisibility() {
      visibility = null;
    ...
    /** Sets the value of the 'user' field */
    public mil.nga.giat.geowave.types.gpx.GpxTrack.Builder setUser(java.lang.CharSequence value) {
    ...
    public mil.nga.giat.geowave.types.gpx.GpxTrack.Builder clearUser() {
      user = null;
    ...
    /** Sets the value of the 'userid' field */
    public mil.nga.giat.geowave.types.gpx.GpxTrack.Builder setUserid(java.lang.Long value) {
    ...
    public mil.nga.giat.geowave.types.gpx.GpxTrack.Builder clearUserid() {
      userid = null;
    ...
    /** Sets the value of the 'description' field */
    public mil.nga.giat.geowave.types.gpx.GpxTrack.Builder setDescription(java.lang.CharSequence value) {
    ...
    public mil.nga.giat.geowave.types.gpx.GpxTrack.Builder clearDescription() {
      description = null;
    ...
    /** Sets the value of the 'tags' field */
    public mil.nga.giat.geowave.types.gpx.GpxTrack.Builder setTags(java.util.List<java.lang.CharSequence> value) {
    ...
    public mil.nga.giat.geowave.types.gpx.GpxTrack.Builder clearTags() {
      tags = null;
