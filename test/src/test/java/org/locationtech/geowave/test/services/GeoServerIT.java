      ...
      final HttpGet command =
          createWFSGetFeature(
              ...
              new BasicNameValuePair(
                  "cql_filter",
                  URLEncoder.encode(
                      "BBOX(geometry,34.68,35.18,34.7,35.19,'CRS:84') and when during 2005-05-19T00:00:00Z/2005-05-19T21:32:56Z",
                      "UTF8")),
      ...
      final HttpGet command =
          createWFSGetFeature(
              ...
              new BasicNameValuePair(
                  "cql_filter",
                  URLEncoder.encode(
                      "BBOX(geometry,34.68,35.18,34.7,35.19,'CRS:84') and when during 2005-05-19T20:32:56Z/2005-05-19T21:32:56Z",
                      "UTF8")),
              new BasicNameValuePair("srsName", "EPSG:4326"));
      final HttpResponse r = httpclient.execute(command, context);
