...
<StyledLayerDescriptor version="1.0.0"
  ...
  <NamedLayer>
    <Name>Heatmap-sum-stats</Name>
    <UserStyle>
      <Title>Heatmap-sum-stats</Title>
      <Abstract>A heatmap surface showing a specified density for field sum statistics using spatial binning.</Abstract>
      <FeatureTypeStyle>
        <Transformation>
          <ogc:Function name="geowave:GeoWaveHeatMap">
            ...
            <ogc:Function name="parameter">
              ...
              <ogc:Literal>SUM_STATS</ogc:Literal>
            </ogc:Function>
            <ogc:Function name="parameter">
